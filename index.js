$vm.module_list={
    ...
    navigation:                  ['--------','.../modules/navigation.html',''],
    daily:                       ['--------','.A./operation/car_booking/daily.html','',  'booking_record'],
    weekly:                      ['--------','.A./operation/car_booking/weekly.html','', 'booking_record'],
    monthly:                     ['--------','.A./operation/car_booking/monthly.html','','booking_record'],
    car:                         ['20003816','.A./operation/car_booking/car.html',''],
    booking_record:              ['20003817','.A./operation/car_booking/booking_record.html',''],
    upload_file:                 ['20007156','.A./document/upload_file.html',''],
}
//--------------------------------------------------------
for(key in $vm.module_list){
    ...
    $vm.module_list[key][1]=$vm.module_list[key][1].replace('.A.','__BASE__/wappsystem/Common-Modules')
